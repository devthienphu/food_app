    ...
    return (
      <>
        ...
        <div className="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
          <img src="https://images.pexels.com/photos/5735836/pexels-photo-5735836.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className="w-full h-full object-cover"/>
        </div>
        ...
        <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
          ...
          <div className="w-full h-100">
            ...
            <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12 text-green-600">Log in to your account</h1>
            ...
            <p className="mt-8">
                  Need an account? 
                  <a href="#" className="text-blue-500 hover:text-blue-700 font-semibold" onClick={()=>{navigate('/SignUp')}}>
                  Create an account
                  </a>
            </p>
            <a className="text-green-500 font-semibold hover:text-green-600 text-lg" href="#" onClick={()=>{navigate('/')}}>Về trang chủ</a>
