    ...
    <div className="flex flex-col md:flex-row justify-center ">
...

        {
            ...
            <div key ={index} className="flex bg-gray-100 rounded-2xl pl-2 border border-green-400 border-2 shadow-lg hover:bg-white">
                    ...
                    <button className="mt-12 mb-12 bg-white rounded-xl m-auto bg-green-300" onClick={()=>setCount(count+1)}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                    </button>
                    
                    <div className=" m-auto rounded-2xl px-2" >{count}</div>
                    ...
                    <p className="m-auto ml-8 text-2xl font-semibold">{cart.price}</p>

                    <button className="bg-red-300 rounded-2xl m-auto ml-12 mr-4">
        ...
        <div className="basis-1/3 bg-gray-100 flex flex-col items-left rounded-2xl mr-16 pb-8">
            ...
            <div className="mx-4 mt-4 items-center flex">
              <div className="flex items-center mb-4 border border-green-500 border-2 bg-white rounded-xl mx-8 mt-4 items-center flex">
                ...
                dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" checked/>
              ...
              <label for="large-input" className="block mb-2 text-sm font-medium text-gray-900 ">Large input</label>
              ...
              <div className="mb-6 mx-4">
              <label for="base-input" className="block mb-2 text-sm font-medium text-gray-900">Base input</label>
              ...
              <div className="mx-4">
              <label for="small-input" className="block mb-2 text-sm font-medium text-gray-900">Small input</label>
              <input type="text" id="small-input" className="bg-gray-50 border border-blue-400 text-gray-900 border-2
              text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
              block w-full p-2.5"/>
              </div>

              <p className="font-semibold text-xl mx-4 mt-4">Total pay: ${490}</p>
