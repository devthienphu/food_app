...
const foodList =[
    ...
    {
        id:4,
        name:'Áo Singlet Nam Chạy Bộ in Graphic Special',
        image:'https://www.mude-sports.com/wp-content/uploads/2022/03/11412-Side-Left.png',
        category:'Áo thun',
        dishDetails:'Sản phẩm được đánh giá phù hợp với hoạt động chạy bộ bởi các Runner',
        price: 198000,
        countRating:5,
        rating:4,
        numReviews:0,
        reviews:[],
        dishDescription:'Mẫu áo được lựa chọn và nghiên cứu kỹ lưỡng từ chất liệu đến thiết kế dành cho chạy bộ, đi bộ hay các hoạt động thể thao ngoài trời',
        isBestSeller:true,
        isCheck:false,
        isCheck:false
    },
